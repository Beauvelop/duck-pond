  ...
  render() {
    return (
      <svg id="pond-svg" viewBox="0 0 1920 1080" preserveAspectRatio="none">
        ...
        <linearGradient id="pond-base-grad" x1="959" x2="959" y1="1081" y2="881" gradientUnits="userSpaceOnUse">
          <stop id="pond-stop1" offset="0" stopColor="var(--darkMist)" stopOpacity="1" />
          <stop id="pond-stop2" offset="1" stopColor="var(--darkMist)" stopOpacity="0" />
        </linearGradient>
        <path id="pond-base" fill="url(#pond-base-grad)" d="M-1 881h1920v200H-1z" opacity="1" />
        <linearGradient
          id="swells-grad"
          x1="961.0376"
          x2="956.9628"
        ...
        <g className="waves-container" opacity=".5">
          ...
          <ellipse id="wave-1" cx="169" cy="1059" fill="url(#wave1-grad)" rx="365" ry="41" />
          <radialGradient
            id="wave2-grad"
            cx="660.5352"
            cy="-103.0996"
          ...
          <ellipse id="wave-2" cx="1215" cy="987.5" fill="url(#wave2-grad)" rx="365" ry="32.5" />
          <radialGradient
            id="wave3-grad"
            cx="1123.3218"
            cy="-333.5391"
          ...
          <ellipse id="wave-3" cx="1812.3" cy="978" fill="url(#wave3-grad)" rx="272.7" ry="27" />
          <radialGradient
            id="wave4-grad"
            cx="800.6421"
            cy="-437.9844"
          ...
          <ellipse id="wave-4" cx="876.3" cy="942" fill="url(#wave4-grad)" rx="272.7" ry="21" />
          <radialGradient
            id="wave5-grad"
            cx="1288.3618"
            cy="-819.4141"
          ...
          <ellipse id="wave-5" cx="1668.2" cy="910.5" fill="url(#wave5-grad)" rx="352.2" ry="14.5" />
          <radialGradient
            id="wave6-grad"
            cx="1237.9141"
            cy="-949.0703"
          ...
          <ellipse id="wave-6" cx="1479.2" cy="890.5" fill="url(#wave6-grad)" rx="352.2" ry="14.5" />
          <radialGradient
            id="wave7-grad"
            cx="410.1729"
            cy="-99.8262"
          ...
          <ellipse id="wave-7" cx="388.8" cy="1023" fill="url(#wave7-grad)" rx="323.2" ry="30" />
          <radialGradient
            id="wave8-grad"
            cx="803.7827"
            cy="-120.2598"
          ...
          <ellipse id="wave-8" cx="946" cy="1037" fill="url(#wave8-grad)" rx="386" ry="25" />
          <radialGradient
            id="wave9-grad"
            cx="356.0615"
            cy="-471.7422"
          ...
          <ellipse id="wave-9" cx="167" cy="943.5" fill="url(#wave9-grad)" rx="377" ry="18.5" />
          <radialGradient
            id="wave10-grad"
            cx="1234.4678"
            cy="-79.3936"
          ...
          <ellipse id="wave-10" cx="1601" cy="1044.5" fill="url(#wave10-grad)" rx="319" ry="32.5" />
          <radialGradient
            id="wave11-grad"
            cx="1025.2515"
            cy="-726.1875"
          ...
          <ellipse id="wave-11" cx="591" cy="897.5" fill="url(#wave11-grad)" rx="619" ry="13.5" />
        </g>
      </svg>
    );
  }
...
<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 1080">
  <linearGradient id="a" x1="959" x2="959" y1="1081" y2="881" gradientUnits="userSpaceOnUse">
    <stop offset="0" stop-color="var(--darkMist)" stop-opacity="0"/>
    <stop offset="1" stop-color="var(--darkMist)"/>
  </linearGradient>
  <path fill="url(#a)" d="M-1 881h1920v200H-1z" opacity=".5"/>
</svg>


---swells----original-----
          <stop id="swell-stop1" offset="0" stopColor="var(--lightMist)" />
          <stop id="swell-stop2" offset=".33" stopColor="#ccc" />
          <stop id="swell-stop3" offset=".66" stopColor="var(--lightMist)" />
          <stop id="swell-stop4" offset="1" stopColor="#ccc" />
